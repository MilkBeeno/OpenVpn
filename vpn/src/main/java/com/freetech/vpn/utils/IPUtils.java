...
public class IPUtils {
     ...
     */
    public static boolean isProposalValid(boolean ike, String proposal) {
        return CharonVpnService.isProposalValid(ike, proposal);
    }
     ...
     */
    private static byte[] parseInetAddressBytes(String address) {
        return CharonVpnService.parseInetAddressBytes(address);
    }
