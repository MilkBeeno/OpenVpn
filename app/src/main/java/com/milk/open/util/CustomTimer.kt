...
class CustomTimer(private val builder: Builder) {
    ...
    private inner class MilkCountDownTimer :
        ...
        override fun onTick(millisUntilFinished: Long) {
            ...
            builder.onTickListener?.invoke(this@CustomTimer, millisUntilFinished)
        }
    ...
    class Builder {
        ...
        internal var onTickListener: ((CustomTimer, Long) -> Unit)? = null
        ...
        fun setOnTickListener(onTickListener: (CustomTimer, Long) -> Unit): Builder {
        ...
        fun build(): CustomTimer {
            return CustomTimer(this)
        }
    }
}